#ifndef INC_INA219_1_H_
#define INC_INA219_1_H_

#define INA219_ADDRESS 							(0x45) // VS VS
...
float INA219_ReadCurrent(INA219_t *ina219); // New function declaration for reading current as float
