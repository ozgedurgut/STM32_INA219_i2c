...
#ifndef INC_INA219_2_H_
#define INC_INA219_2_H_

#define INA219_ADDRESS_2 							(0x45) // A1 SCL - A0 VS
...
typedef struct
{
	I2C_HandleTypeDef 	*ina219_i2c_2;
	uint8_t				Address_2;
} INA219_t_2;

extern uint16_t ina219_calibrationValue_2;
extern float ina219_currentDivider_mA_2;
extern float ina219_powerMultiplier_mW_2;

uint8_t INA219_Init_2(INA219_t_2 *ina219, I2C_HandleTypeDef *i2c, uint8_t Address);
